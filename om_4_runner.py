# -*- coding: utf-8 -*-
"""
Created on Mon Dec 24 11:47:44 2018
...
def add_om_4_extension(file):
    """
    Return the file with the .4om extension on the end.
    
    Parameters:
        file: The file to return with the .4om extension.
    """
        ...
        with open(file) as f:
            ...
            for line in f:
                ...
                if len(line) > 0 and line[0] == '@':
                    line = line [1:]
                    names = line.split()
                    names = [add_om_4_extension(name) for name in names]
...
def run_om_4_project(folder, interpreter):
    """
    Run a 4om project.
